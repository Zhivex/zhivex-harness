...
const child=spawn(path.join(root,"node_modules/electron/dist/Electron.app/Contents/MacOS/Electron"),[path.join(import.meta.dir,process.argv.includes("--updates")?"update-ui-runner.cjs":credentials?"credential-ui-runner.cjs":"layout-runner.cjs"),build,report],{cwd:root,env:{PATH:process.env.PATH,HOME:report},stdio:["ignore","ignore","pipe"]});
