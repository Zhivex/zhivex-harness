...
const child=spawn(path.join(root,"node_modules/electron/dist/Electron.app/Contents/MacOS/Electron"),[path.join(import.meta.dir,"layout-runner.cjs"),build,report],{cwd:root,env:{PATH:process.env.PATH,HOME:report},stdio:["ignore","ignore","pipe"]});
