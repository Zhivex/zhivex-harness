...
export function fixtureOciRuntime():HarnessOciRuntimeAdapter{
 return {async inspectImage(imageReference){const imageDigest="sha256:"+"a".repeat(64);return {runtime:"docker",runtimeVersion:"desktop-fixture",imageReference,imageId:imageDigest,imageDigest};},async run(request){
