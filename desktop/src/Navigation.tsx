...
export function Navigation(props:{projects:DesktopProject[];context:DesktopContext|undefined;sessions:HarnessClientSession[];selectedSession:string|undefined;loading:boolean;open:()=>void;selectProject:(key:string)=>void;selectSession:(id:string)=>void;create:()=>void}){
 ...
 <div className="connection">● {props.context?"Servicio local conectado":"Elegí un repositorio"}</div></aside>;
}
