...
## Next version: 1.2.0-rc.4

Source version: `1.2.0-rc.4` (RC publication to `next` pending). RC.10 passed its complete
...
| `1.2.0-rc.4` | Compatible minor | CLI, context, local service and governed delegation | Pending RC publication | L |
