...
3. Complete deterministic, installed-artifact, and real-OCI validation for RC.9, then run the exact annotated tag through artifact binding, live-provider, mixed-routing, model-directed OCI, and the complete representative matrix before any publication decision.
