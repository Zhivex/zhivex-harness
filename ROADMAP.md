...
Source version: `1.1.1` (stable publication pending). RC.10 passed its complete
...
| `1.1.1` | Compatible minor | CLI, context, local service and governed delegation | Pending stable publication | L |
