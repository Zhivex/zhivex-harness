...
## Next version: 1.2.0-rc.7

Source version: `1.2.0-rc.7` (RC publication to `next` pending). RC.10 passed its complete
...
| `1.2.0-rc.7` | Compatible minor | CLI, context, local service and governed delegation | Pending RC publication | L |
