...
3. Preserve RC.9 as a failed, unpublished deterministic-validation attempt and complete deterministic, installed-artifact, and real-OCI validation for RC.10 before its exact annotated tag enters artifact binding, live-provider, mixed-routing, model-directed OCI, and the complete representative matrix.
