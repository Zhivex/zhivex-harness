...
Version `1.2.0-rc.9` is prepared as an unpublished release candidate for npm `next`,
with task continuity, dependency inspection and quieter console progress improvements. Certification
...
1.2.0-rc.9 once published; stable users can install `@zhivex-ai/harness@latest`.
