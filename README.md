...
Version `1.1.0` is prepared for stable publication, with console, local service
...
records its verified artifact. The installation commands below target 1.1.0 once
...
```sh
npm install -g @zhivex-ai/harness@1.1.0
