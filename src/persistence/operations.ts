...
import { defaultHarnessNamespace, type HarnessConfig, type HarnessStoreBackend } from "../runtime/config.js";
...
// Keep the published declaration explicit: inference can choose a different SDK
// re-export of the same type when source module traversal order changes.
export const inspectHarnessRun = async (
  ...
  runId: string
    ...
    run: {
        ...
        scope: import("@zhivex-ai/core").AgentStoreScope | undefined;
        steps: number;
        toolCalls: number;
        toolErrors: number;
        ...
        compactions: number;
        childRuns: number;
        usage: import("@zhivex-ai/core").TokenUsage | undefined;
        startedAt: number | undefined;
        updatedAt: number | undefined;
        cancelledAt: number | undefined;
        cancellationReason: string | undefined;
    };
    budget: import("@zhivex-ai/core").AgentBudgetStatus;
    snapshot: {
        runId: string;
        agentId?: string;
        status: AgentStatus;
        ...
        modelId: string;
        steps: number;
        toolCalls: import("@zhivex-ai/core").ToolCall[];
    ...
    trace: import("@zhivex-ai/core").AgentTraceArtifact;
    hierarchy: import("@zhivex-ai/core").HierarchicalAgentTrace | undefined;
    ledger: {
        schemaVersion: typeof import("@zhivex-ai/core").AGENT_CONTROL_PLANE_SCHEMA_VERSION;
        ...
        audit: import("@zhivex-ai/core").AgentAuditRecord;
        toolAudit: import("@zhivex-ai/core").ToolAuditRecord[];
        timeline?: import("@zhivex-ai/core").AgentReplayResult["timeline"];
        trace: import("@zhivex-ai/core").AgentTraceArtifact;
        summary: import("@zhivex-ai/core").AgentTraceSummary;
        cost?: import("@zhivex-ai/core").CostEstimate;
        metadata?: Record<string, import("@zhivex-ai/core").JsonValue>;
        snapshot: {
            runId: string;
            agentId?: string;
            status: AgentStatus;
    ...
    runtimeDiagnostics: {
        ...
        budget: {
            ...
            inFlight: boolean;
            stopReason: "INPUT_TOKEN_BUDGET" | "OUTPUT_TOKEN_BUDGET" | "USAGE_UNAVAILABLE" | "WORK_TOKEN_BUDGET" | null;
            reservedInputTokens: number;
            reservedOutputTokens: number;
            predictedInputTokens: number;
            outputCapApplied: boolean;
        };
        phase: "candidate" | "delivered" | "explore" | "incomplete" | "recover" | "reproduce" | "verify";
        ...
        contextMeasurements: {
            ...
            otherMessageCharacters: number;
            toolDefinitionCharacters: number;
            unmeasuredToolDefinitions: number;
        }[];
        modelTimings: {
            durationMs: number;
        ...
        omittedContextMeasurements: number;
        checks: {
    ...
    usageLedger: {
        ...
        schemaVersion: 1;
        runId: string;
        historicalUsageUnknown?: boolean | undefined;
        costKind: "estimate-not-invoice";
        routes: {
            provider: string;
            model: string;
            calls: number;
            ...
            unknownCalls: number;
            estimatedUsd: number | null;
            priceStatuses: ("estimate" | "missing" | "stale")[];
        }[];
    } | null;
    effectiveRuntime: {
        schemaVersion: 1;
    ...
    toolJournal: {
        toolCallId: string;
        toolName: string;
        status: import("@zhivex-ai/core").AgentToolCallJournalStatus;
        revision: number;
        startedAt: number | undefined;
